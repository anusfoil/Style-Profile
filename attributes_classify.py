...
def classify():
    ...
    artists_counts=meta_attributes[d].value_counts() # remove class with few data
    filtered_labels = artists_counts[artists_counts>20].index
    meta_attributes = meta_attributes[meta_attributes[d].isin(filtered_labels)]
